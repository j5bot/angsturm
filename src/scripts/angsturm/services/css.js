  ...
  .factory('AngsturmDynamicCSS', [
    ...
    function (
      ...
      function getForeground (properties) {
        ...
        result.class = 'fg_' + color.replace(classnameRE, '-');
      ...
      function getBackground (properties) {
        ...
        switch (flags) {
          ...
          case 4:
          case 6:
            result.class = color.replace(classnameRE, '-');
            result.style = COLOR_INTERPOLATER({
          ...
          // color behind image
          case 2:
            result.class = color.replace(classnameRE, '-') + '_' + (imageName || image).replace(classnameRE,'-');
            result.style = COLOR_INTERPOLATER({
              property: 'background-color',
              color: color
            }) + '\n' + IMAGE_INTERPOLATER({
          ...
          case 3:
          case 1:
            result.class = (imageName || image).replace(classnameRE,'-');
      ...
      function getBorder (properties) {
        ...
        result.class = 'border_' + color.replace(classnameRE,'-') +
          '_solid_' + width.replace(/px/g,'').replace(classnameRE,'-') +
            (radius ? '_' + radius.replace(classnameRE,'-') : '') +
              (circle ? '_circle' : '');
      ...
      function getPadding (properties) {
        ...
        result.class = 'pad_' + width.replace(/px/g,'').replace(classnameRE,'-');
      ...
      function getShadow (properties) {
        ...
        result.class = 'shadow' +
          (color !== true ? color.replace(classnameRE,'-') : '') + 
