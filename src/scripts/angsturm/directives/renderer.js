...
.directive('renderer', [
    ...
    function (
      ...
      var containerTemplateUrl = 'renderer-items',
        itemTemplateUrl = 'renderer-item';
      ...
      return {
        ...
        compile: function ($templateElement, $templateAttributes) {
          ...
          function renderElement ($s, $t, $a, layout) {
            ...
            $s.containerTemplate = $templateCache.get(($s.mode ? $s.mode + '-' : '') + containerTemplateUrl + '.html');
            $s.itemTemplate = $templateCache.get(($s.mode ? $s.mode + '-' : '') + itemTemplateUrl + '.html');
          ...
          return RecursionHelper.compile($templateElement, RenderHelper);
